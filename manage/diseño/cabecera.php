  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top nav-config" id="mainNav">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Panel de Control">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tablas">
          ...
          <ul class="sidenav-second-level collapse" id="collapseCategoria">
            <li>
              <a href="#" id="verCat"><i class="fa fa-fw fa-eye"></i>Ver Categorias</a>
            </li>
            <li>
              <a href="#" id="regCat"><i class="fa fa-fw fa-pencil"></i>Registrar Categorias</a>
            </li>
          </ul>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tablas">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseTema" data-parent="#exampleAccordion">
            <i class="fa fa-fw fa-fax"></i>
            <span class="nav-link-text">Tema</span>
          </a>
          <ul class="sidenav-second-level collapse" id="collapseTema">
            <li>
              <a href="#" id="verT"><i class="fa fa-fw fa-eye"></i>Ver Temas</a>
            </li>
            <li>
              <a href="#" id="regT"><i class="fa fa-fw fa-pencil"></i>Registrar Temas</a>
            </li>
          </ul>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tablas">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapsePregunta" data-parent="#exampleAccordion">
            <i class="fa fa-fw fa-question-circle"></i>
            <span class="nav-link-text">Pregunta</span>
          </a>
          <ul class="sidenav-second-level collapse" id="collapsePregunta">
            <li>
              <a href="#" id="verP"><i class="fa fa-fw fa-eye"></i>Ver Preguntas</a>
            </li>
            <li>
              <a href="#" id="regP"><i class="fa fa-fw fa-pencil"></i>Registrar Preguntas</a>
            </li>
          </ul>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Menu Levels">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseMulti" data-parent="#exampleAccordion">
            ...
            <span class="nav-link-text">Alternativa</span>
          </a>
          <ul class="sidenav-second-level collapse" id="collapseMulti">
            <li>
              <a href="#" id="verA">Ver Alternativas</a>
            </li>
            <li>
              <a href="#" id="regA">Registrar Alternativas</a>
            </li>
            <li>
